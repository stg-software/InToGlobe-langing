      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2">
            ...
            <h1 className="font-display text-5xl lg:text-6xl font-extrabold leading-tight mb-6 text-gray-900 dark:text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <button className="flex items-center gap-2 font-display font-semibold text-gray-700 dark:text-gray-300 px-6 py-3.5 rounded-full border border-gray-200 dark:border-gray-700 hover:border-brand-purple hover:text-brand-purple transition-all duration-200 text-base">
                {t("hero.ctaSecondary")}
