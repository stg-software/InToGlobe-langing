...
export default function Navbar() {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <div className="relative" ref={langRef}>
              ...
              {langOpen && (
                <div className={`absolute right-0 mt-1 w-36 rounded-xl shadow-lg border overflow-hidden z-50 ${
      ...
      {/* ── Mobile menu ── */}
      {mobileOpen && (
        <div className={`lg:hidden border-t px-6 py-4 shadow-lg ${
          ...
          <nav className="flex flex-col gap-4">
            ...
            {/* Idiomas en mobile */}
            <div className={`flex gap-2 pt-2 border-t ${isDark ? "border-gray-800" : "border-gray-100"}`}>
              {LANGS.map((lang) => (
                <button
                  key={lang.code}
                  onClick={() => handleLangChange(lang.code)}
